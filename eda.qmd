...
La función `car::symbox(...)` permite probar varias combinaciones típicas del parámetro 
$\lambda$ , para comprobar con cuál de ellas obtenemos una distribución más simétrica de valores.
